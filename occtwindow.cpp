...
IMPLEMENT_STANDARD_HANDLE(OcctWindow,Aspect_Window)
//IMPLEMENT_STANDARD_RTTI(Sketcher_CommandCircleCenterRadius,Sketcher_Command)
//IMPLEMENT_STANDARD_RTTI(OcctWindow)
//IMPLEMENT_STANDARD_RTTI(Sketcher_Command)

IMPLEMENT_STANDARD_TYPE(OcctWindow)
IMPLEMENT_STANDARD_SUPERTYPE(Aspect_Window)
IMPLEMENT_STANDARD_SUPERTYPE(MMgt_TShared)
IMPLEMENT_STANDARD_SUPERTYPE(Standard_Transient)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_ENTRY (Aspect_Window)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_ENTRY (MMgt_TShared)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_ENTRY (Standard_Transient)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(OcctWindow)
